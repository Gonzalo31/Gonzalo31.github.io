function multiply() {
	document.getElementById("myTextarea3").value = document.getElementById("myTextarea1").value * document.getElementById("myTextarea2").value
}

function showHTML() {
	document.getElementById("language").innerHTML = "HTML";
	document.getElementById("lang_description").innerHTML = "This is the code that writes everything in black and white, and also add the images to the webpage.";
...
It’s a shame I deleted the first website that I have ever done, however I can show you this one, made in October or November 2016. Click here to see it. Even though it is poorly designed, I think it was a big step to learning essential parts of a good website. In this example, I made for the first time a header and a footer.<br>
...
<div class="textSection">
<h2 id="conclusion"><span class="titleLetter" >C</span>ode</h2>
	<p class="onlyTextSection-p">Click <a class="external_links"  href="/code.html">here</a> to see the code to make this website.
</p>
</div>
</body>
</html>
...
function showCSS() {
	document.getElementById("language").innerHTML = "CSS";
	document.getElementById("lang_description").innerHTML = "This part basically makes all the HTML look nicer, by giving it color or a font for example.";
	document.getElementById("textarea").value =
`body {
	border-top: #F14144 solid 5px;
	margin: 0px;
...
.inter_links_top a:hover {
    background-color: #F1F1F1;
}
.inter_links_bottom a:hover {
...
.firstPicSection {
  background-image: linear-gradient(rgba(0, 0, 0, 0.6),rgba(0, 0, 0, 0.5)), url(images/camping.jpg);
  background-size: cover;
  height: 90vh;
  background-attachment: fixed;
  background-position: center;
  background-repeat: no-repeat;
  /*border-bottom: #F14144 solid 5px;*/
}
...
.secondPicSection {
  background-image: linear-gradient(rgba(0, 0, 0, 0.6),rgba(0, 0, 0, 0.5)), url(images/boats.jpg);
  background-size: cover;
  height: 90vh;
	background-attachment: fixed;
    background-position: center;
...
.thirdPicSection {
  background-image: linear-gradient(rgba(0, 0, 0, 0.6),rgba(0, 0, 0, 0.5)), url(images/french_debating_team.jpg);
  background-size: cover;
  height: 90vh;
	background-attachment: fixed;
    background-position: center;
...
.wafflePicSection {
  background-image: linear-gradient(rgba(0, 0, 0, 0.01),rgba(0, 0, 0, 0.02)), url(images/waffles_poster.png);
  background-size: cover;
  height: 90vh;
	/*background-attachment: fixed;*/
    background-position: center;
...
function showJavaScript() {
	...
	document.getElementById("lang_description").innerHTML = "JavaScript makes webpages interactive. It can detect when you push a button and it also has the power to edit both the HTML and CSS.";
	document.getElementById("textarea").value =
`function multiply() {
	document.getElementById("myTextarea3").value = document.getElementById("myTextarea1").value * document.getElementById("myTextarea2").value
}
